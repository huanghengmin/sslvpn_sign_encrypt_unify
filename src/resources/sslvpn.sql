...
--
-- Table structure for table `threea`
--
...
CREATE TABLE `threea` (
  ...
  `lowermode` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `threea`
--

LOCK TABLES `threea` WRITE;
/*!40000 ALTER TABLE `threea` DISABLE KEYS */;
INSERT INTO `threea` VALUES (2,'192.168.1.1',80,'方案一'),(3,'1.1.1.1',80,'策略一'),(4,'1.1.1.1',80,'策略一'),(5,'2.2.2.2',90,'策略一'),(6,'3.3.3.3',80,'策略一');
/*!40000 ALTER TABLE `threea` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-07 17:46:33
